...
# This is the heart of the desktop experience, configuring Hyprland.
...

{
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      # source = ~/.config/hyprland/myColors.conf
      ...
      # Screenshot bindings
      bind = , Print, exec, grim -g "$(slurp)" - | wl-copy # Select area and copy to clipboard
      bind = $mainMod, Print, exec, grim - | wl-copy # Screenshot active window and copy
    '';
  };
}
